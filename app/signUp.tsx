...
const signUp = () => {
  ...
  return (
     <View className='flex-1 bg-primary items-center justify-center relative'>
              ...
              <TextInput value={confirmPassword} placeholder='Confirm Password' onChangeText={setConfirmPassword} secureTextEntry className='w-80 bg-dark-200 rounded-full px-5 py-3 mt-5 text-white' placeholderTextColor='#a8b5db' />
              <Button title="SignUp" color="#007AFF" onPress={() => router.push("/(tabs)")}  />
